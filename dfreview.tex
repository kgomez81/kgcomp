...
\end{align*}
The key insight obtained from these two expressions, are that the parameters $ln[Ns]$ and $ln[s/U_b]$ each summarize the contributions of selection and mutation to dynamics of the evolving population, respectively.  Specifically, the separate appearance of the terms $N$ and $U_b$ in the speed of evolution $v$, show how the    
